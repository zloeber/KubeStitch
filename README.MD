...
> **NOTE** Mac users should not use the dns-proxy-server as it simply doesn't work from what I can tell. The DPS container starts and has the correct configuration but the local /etc/resolve.conf 
